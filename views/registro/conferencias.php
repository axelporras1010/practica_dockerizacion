...
<h2 class="registrar__heading"><?php echo $titulo; ?></h2>
<p class="registroar__descripcion">Elige hasta 5 eventos para asistir de forma presencial</p>
...
<div class="eventos-registro">
    ...
    <aside class="registro">
        ...
        <form id="registro" class="fomulario">
